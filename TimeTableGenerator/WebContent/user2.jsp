...
<body>
	...
	<form id="facultySubjectsForm" action="facultySubjects" method="post">
		<div class="container" id="mainTT">
			...
			<br> <br>
			<div class="row">
				<div class="col-sm-4" style="text-align: center; height: 2.6em">
					<select style="height: 100%; width: 80%">
				...
				<div class="col-sm-4" style="text-align: center; height: 2.6em">
					<select id="session" style="height: 100%; width: 80%">
						<option disabled="disabled" selected="selected">--Select
							Session</option>
						<option value="July-Dec">July - December</option>
						<option value="Jan-June">January - June</option>
					</select>
				</div>
				<div class="col-sm-4" style="text-align: center; height: 2.6em">
					<select id="classes" style="height: 100%; width: 80%">
						<option disabled="disabled" selected="selected">--Select
							Classes</option>
					</select>
				</div>
			...
			<div class="row" style="background: #2d2d2d">
				...
				<div class="col-sm-3">
					<label class="lblTableHead">Subject Name</label>
				</div>
				<div class="col-sm-2">
			...
			<div class="container" id="selectEntries">
				<div class="row" id="prototype-row">
					...
					<div class="col-sm-2 field-container">
						<select disabled="disabled" style="background: rgb(210, 210, 210)"
							name="fac20" class="fac2">
						</select>
					</div> -->
				</div>
			</div>
